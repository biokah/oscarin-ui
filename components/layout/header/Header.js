    ...
    return (
      <header className="c_header absolute bg-white top-0 left-0 right-0 flex items-center justify-between">
        <section className="flex">
          ...
          <nav className="nav">
            <ul className="flex">
              <li className={`rounded-lg ${router.pathname === "/" ? "active" : ""}`}>
                <Link href="/">Mi quiniela</Link>
              </li>
              <li className={`rounded-lg ${router.pathname === "/ranking" ? "active" : ""}`}>
                <Link href="/ranking">Ranking</Link>
              </li>
              <li className={`rounded-lg ${router.pathname === "/rules" ? "active" : ""}`}>
